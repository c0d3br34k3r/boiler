...
public class InOperatorTest {
	...
	public void testApply() throws Exception {
		assertThat(new InOperator().apply("1", new MockLazyTerm(Arrays.asList("0", "1", "2"))))
				.isEqualTo(true);
		assertThat(new InOperator().apply("1", new MockLazyTerm(Arrays.asList("0", "3", "2"))))
				.isEqualTo(false);
		assertThat(new InOperator().apply("1",
		...
		assertThat(new InOperator().apply("1",
				new MockLazyTerm(new Composite(new SingletonBindings("0", "a"),
						new SingletonBindings("3", "1"), new SingletonBindings("2", "c")))))
								.isEqualTo(false);
		assertThat(
				new InOperator().apply("1", new MockLazyTerm(new ArrayIterable<>("0", "1", "2"))))
						.isEqualTo(true);
		assertThat(
				new InOperator().apply("1", new MockLazyTerm(new ArrayIterable<>("0", "3", "2"))))
						.isEqualTo(false);
	}
