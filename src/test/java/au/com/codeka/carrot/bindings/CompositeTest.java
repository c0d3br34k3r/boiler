...
public class CompositeTest {
	...
	public void testResolved() throws Exception {
		...
		assertThat(new Composite(new EmptyBindings(), new EmptyBindings()).resolve("key"),
				CoreMatchers.nullValue());

		assertThat(new Composite(new SingletonBindings("key", "value")).resolve("key"),
				CoreMatchers.<Object> is("value"));
		assertThat(new Composite(new EmptyBindings(), new SingletonBindings("key", "value"))
	...
	public void testIsEmpty() throws Exception {
		...
		assertThat(new Composite(new EmptyBindings(), new EmptyBindings()).isEmpty(),
				CoreMatchers.is(true));

		assertThat(
				new Composite(new EmptyBindings(), new SingletonBindings("key", "value")).isEmpty(),
