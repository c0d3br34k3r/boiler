...
/**
 * Composite {@link Bindings} which combines the values of other
 * {@link Bindings} into one. Note that the order is important in case two
 * bindings contain a value with the same key. In such case the first binding
 * wins.
 *
 * <p>
 ...
 *
 * <p>
 * Given that the key {@code "key"} exists in both, the {@code map} and the
 * {@code jsonObject} you would access them like:
 *
 * <pre>
 * <code>
 * Map key: {{ key }}
