 ...
 * </pre>
 * <p>
 * Note: strictly spoken this would not be necessary, because the reflection
 * function resolution would do the same (by calling {@link Map.Entry#getKey()}
 * and {@link Map.Entry#getValue()}. A dedicated {@link Bindings} class is,
