...
public class HtmlHelper {
	 ...
	 * 
	 * @param html The string you want to mark as safe. The string will not be
	 *        escaped on output, even if {@link Configuration#getAutoEscape} is
	 *        true.
	 ...
	 * @return A {@link SafeString} (so that the string doesn't get
	 *         double-escaped).
	 */
	...
	/**
	 * Escape the HTML. This variant takes a {@link SafeString}, and because we
	 * already know a safe string is safe to output, we <em>won't</em> escape it
	 * again.
	 *
	 * @param html The string you want to HTML-escape.
